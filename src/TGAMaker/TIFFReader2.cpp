...
IMPLEMENT_DYNAMIC(CTIFFReader2, CImageReader2);

CTIFFReader2::CTIFFReader2()
{
  m_bOpened = FALSE;
...
void CTIFFReader2::Open(LPCSTR lpszFileName)
{
  CFileException e;
...
BOOL CTIFFReader2::ReadInformations()
{
  HEADER header;
...
BOOL CTIFFReader2::ReadPixelFormat()
{
  IFD_ENTRY entry;
...
BOOL CTIFFReader2::ReadCompresionType()
{
  IFD_ENTRY entry;
...
BOOL CTIFFReader2::ReadStripFormat()
{
  IFD_ENTRY entry;
...
BOOL CTIFFReader2::ReadStripOffsets()
{
  IFD_ENTRY entry;
...
BOOL CTIFFReader2::ReadImage(BYTE * pByte, DWORD dwPitch)
{
  DWORD dwStrip;
  CRect rect;
...
void CTIFFReader2::AssertValid() const
{
  CImageReader2::AssertValid();
}

void CTIFFReader2::Dump(CDumpContext & dc) const
{
