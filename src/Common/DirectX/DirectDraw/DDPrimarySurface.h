...
public:
  ...
  // returns the screen rect (can differ from GetAllRect())
  CRect *GetScreenRect(){ return &m_rcWholeScreen; }
  // sets the screen rect (don't use it)
  void SetScreenRect(CRect &rcScreen){ m_rcWholeScreen = rcScreen; }
...
private:
  ...
  // the rect for whole screen
  // in nonexclusive mode, this can differ from the GetAllRect()
  CRect m_rcWholeScreen;
};
