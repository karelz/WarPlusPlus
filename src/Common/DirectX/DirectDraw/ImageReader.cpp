...
void CImageReader::Open(CArchiveFile *pFile, void (*FinishRGBProc)(CDDrawSurface *, LPBYTE, DWORD, LPVOID), LPVOID pFinishRGBProcParam)
{
  m_pFile = pFile;
  m_pFinishRGBProc = FinishRGBProc;
  m_pFinishRGBProcParam = pFinishRGBProcParam;
}
