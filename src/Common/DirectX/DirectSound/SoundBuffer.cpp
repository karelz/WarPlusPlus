...
void CSoundBuffer::SetFile(CArchiveFile File, EFileType eFileType)
{
  CString strFileName;
...
BOOL CSoundBuffer::Create(CArchiveFile File, EFileType eFileType)
{
  SetFile(File, eFileType);

  return CDSoundBuffer::Create();
}
