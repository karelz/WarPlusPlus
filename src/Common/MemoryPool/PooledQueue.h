 ...
 *   Autor: Karel Zikmund
 * 
 *   Popis: Šablona poolované fronty
 * 
 ***********************************************************/

#ifndef __POOLED_QUEUE__HEADER_INCLUDED__
#define __POOLED_QUEUE__HEADER_INCLUDED__

#include "TypedMemoryPool.h"

//////////////////////////////////////////////////////////////////////
// Šablona tøídy poolované fronty
...
protected:
	...
	static CTypedMemoryPool<struct SQueueMember> m_cPool;
};

//////////////////////////////////////////////////////////////////////
// Metody šablony CPooledQueue
...
// konstruktor
template <class Element, int nStaticCopyNumber> 
inline CPooledQueue<Element, nStaticCopyNumber>::CPooledQueue () 
{
...
// získá první prvek "cElement" z fronty (FALSE=fronta je prázdná)
template <class Element, int nStaticCopyNumber> 
inline BOOL CPooledQueue<Element, nStaticCopyNumber>::Get ( Element &cElement ) const 
{
...
template <class Element, int nStaticCopyNumber> 
inline BOOL CPooledQueue<Element, nStaticCopyNumber>::GetNext ( POSITION &rPosition, 
	Element &cElement ) 
{
...
// vrátí poèet prvkù fronty
template <class Element, int nStaticCopyNumber> 
DWORD CPooledQueue<Element, nStaticCopyNumber>::GetSize () const 
{
...
// vyjme první prvek fronty a vrátí jeho hodnotu
template <class Element, int nStaticCopyNumber> 
inline Element CPooledQueue<Element, nStaticCopyNumber>::RemoveFirst () 
{
...
template <class Element, int nStaticCopyNumber> 
inline BOOL CPooledQueue<Element, nStaticCopyNumber>::RemoveFirst ( Element &cElement ) 
{
	// zjistí, je-li fronta prázdná
	if ( m_pFirst == NULL )
	{	// fronta je prázdná
...
// pøidá do fronty prvek "cElement"
template <class Element, int nStaticCopyNumber> 
inline void CPooledQueue<Element, nStaticCopyNumber>::Add ( Element cElement ) 
{
...
// smaže z fronty prvek "cElement" (FALSE=prvek nebyl ve frontì nalezen)
template <class Element, int nStaticCopyNumber> 
BOOL CPooledQueue<Element, nStaticCopyNumber>::RemoveElement ( Element &cElement ) 
{
...
//		odkazuje na další prvek seznamu)
template <class Element, int nStaticCopyNumber> 
Element CPooledQueue<Element, nStaticCopyNumber>::RemovePosition ( 
	POSITION position ) 
{
...
// vyjme z fronty všechny prvky
template <class Element, int nStaticCopyNumber> 
void CPooledQueue<Element, nStaticCopyNumber>::RemoveAll () 
{
	// uschová si ukazatel na první prvek fronty
	struct SQueueMember *pMember = m_pFirst;
	...
	while ( pMember != NULL )
	{
		// uschová si ukazatel na mazaný prvek fronty
		struct SQueueMember *pDeletedMember = pMember;

		// posune ukazatel na další prvek fronty
		pMember = pMember->pNext;
...
#endif //__POOLED_QUEUE__HEADER_INCLUDED__
